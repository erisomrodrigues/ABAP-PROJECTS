...
2. CDS com parametros usando *WITH PARAMETERS* com clausula [_WHERE SPRAS = P_SPRAS_](/CDS_VIEW/ZCDS_SPFLI_ERI/ZCDS_PARAMETERS_ERI.ABAP) ou usando [_WHERE SPRAS = :P_SPRAS_](/CDS_VIEW/ZCDS_SPFLI_ERI/ZCDS_M2A4_ERI.ABAP) 
