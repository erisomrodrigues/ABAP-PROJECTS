...
2. CDS com parametros usando *WITH PARAMETERS* com clausula [_WHERE SPRAS = P_SPRAS_](/CDS_VIEW/PARAMETERS/ZCDS_PARAMETERS_ERI.ABAP) ou usando [_WHERE SPRAS = :P_SPRAS_](/CDS_VIEW/PARAMETERS/ZCDS_M2A4_ERI.ABAP) 
