...
8. Usando o [ASSIGN](TIPS_&_TRICK/ZPRG_ASSIGN_PILHA_ABAP.ABAP) para recuperar valores pela pilha ABAP que não existem localmente ou globalmente.
...
2. 
### CDS VIEW
1. CDS simples com a tabela [SPFLI](/CDS_VIEW/ZCDS_SPFLI_ERI/ZCDS_SPFLI_ERI.ABAP).
2. CDS com parametros usando *WITH PARAMETERS* com clausula [_WHERE SPRAS = :P_SPRAS_](/CDS_VIEW/PARAMETERS/ZCDS_PARAMETERS_ERI.ABAP) ou usando [_WHERE SPRAS = $PARAMETERS.P_SPRAS_](/CDS_VIEW/PARAMETERS/ZCDS_M2A4_ERI.ABAP) 
