...
1. Criando ALV simples no ABAP classico usando os modulos de função [REUSE_ALV_FIELDCATALOG_MERGE para catalogo de campos e REUSE_ALV_LIST_DISPLAY](/ALV PROJECT/ZPROG_ALV_DISPLAY_ERI.ABAP) para exibição.
